...
const BannerSection = () => {
  return (
    <section className="absolute left-0 right-0 flex flex-col mt-10 mb-5 select-none lg:flex-row">
      <div className="h-[450px] md:h-[500px] lg:flex-1 flex lg:h-[600px]">
        <img
          src="/public/banner1.png"
          alt="banner"
          className="object-cover w-full h-full md:object-cover lg:object-cover"
        />
      </div>
